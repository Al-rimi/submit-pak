...
class StudentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        // List of students to seed into the database
        $students = [
        ...
        // Seed each student into the database
        foreach ($students as $studentID => $studentName) {
            Student::create([
                'student_id' => (string)$studentID,  // Explicitly cast to string to ensure compatibility
                'student_name' => $studentName,     // Set the student's name
                'submit_count' => 0,                // Initialize submission count to 0
            ]);
        }
    }
}
